// Permission transform — PROJECT-OWNED SCAFFOLD — EXAMPLE (F-intent).
//
// ┌──────────────────────────────────────────────────────────────────────────┐
// │ OWNERSHIP: project_owned (shipped as reference documentation).             │
// │ This is an EXAMPLE showing how a consuming project contributes typed       │
// │ permission intent. Copy this file to `config-transform.mjs`, then EDIT     │
// │ THAT COPY (project_owned) and fill in your project's specifics. The        │
// │ harness never overwrites your `config-transform.mjs`.                      │
// └──────────────────────────────────────────────────────────────────────────┘
//
