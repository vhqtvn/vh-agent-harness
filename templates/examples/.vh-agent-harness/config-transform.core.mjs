// Permission transform types + helpers — EXAMPLE (platform_managed docs).
//
// ┌──────────────────────────────────────────────────────────────────────────┐
// │ OWNERSHIP: platform_managed (shipped as reference documentation).          │
// │ This is an EXAMPLE of the harness-owned support file. Copy this file to    │
// │ `config-transform.core.mjs`, then EDIT THAT COPY (platform_managed) if you │
// │ need to change it. The harness regenerates `config-transform.core.mjs` on  │
// │ every update.                                                              │
// └──────────────────────────────────────────────────────────────────────────┘
//
