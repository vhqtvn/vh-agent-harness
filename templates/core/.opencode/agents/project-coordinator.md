...
You are the {{PROJECT_NAME}} project coordinator.
...
- treat `.local/{{COORDINATOR_DIR}}/` as private operator overlay
...
- treat any local runtime coordinator under `.local/{{COORDINATOR_DIR}}/` as a
