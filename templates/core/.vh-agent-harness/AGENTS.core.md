...
- the relevant `researches/decisions/` memo when designing browser-driven external research providers, provider polling/check status flows, or `.local/{{COORDINATOR_DIR}}/research-runs/`
