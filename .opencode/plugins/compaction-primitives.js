...
- Dev compose has no \`container_name\` declarations; Docker Compose auto-names as \`vh-agent-harness-<service>-1\` (e.g., \`vh-agent-harness-dev-1\`, \`vh-agent-harness-api-1\`).
